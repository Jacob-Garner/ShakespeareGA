...
For more info on genetic algorithms, see the wikipedia page on it:
...
1. Open "Program.cs"
2. In "Main" find the line: string targetPhrase = "To be or not to be";
3. Change the text inside the quotation marks to what ever you want.

To change the population size
1. Open "Program.cs"
2. In "Main" find the line: int populationSize = 500;
...
1. Open "Program.cs"
2. In "Main" find the line: GeneticAlgorithm ShakespeareGA = 
